...
function OrderDetailView({ order, onClose }) {
            ...
            return (
                        <div className='absolute bg-slate-500 bg-opacity-30 top-0 right-0 left-0 bottom-0 flex justify-center items-start p-10'>
                                    <div className='bg-[#EDF6F9] w-[50%] p-10 z-40 rounded-xl shadow-lg'>
                                                <div className='w-full flex justify-end mr-4 '>
                                                            <MdClose className='bg-red-600 text-[#fff] text-xl cursor-pointer rounded-full' onClick={() => onClose()} />
                                                </div>
                                                <div className='grid grid-flow-col grid-cols-2 mt-3 bg-white rounded-lg shadow-md py-2'>
                                                            <div className='px-1' style={{borderRight:'0.05px solid gray'}}>
