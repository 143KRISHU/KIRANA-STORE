        ...
        <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                    ...
                    <div className="mb-2 flex mr-4 gap-2">
                      <div className="min-w-24 flex items-center justify-center ">
                        <button type="button" className="h-8 w-8 text-2xl flex items-center justify-center " onClick={() => decreaseProductCount(product)}
                          ...
                          style={{
                            cursor: isProductCoutUpdating ? 'not-allowed' : 'pointer',
                            visibility: product.quantity === 1? 'hidden':'visible'
                          }}>
                          -
                        </button>
                        <input
          ...
          >
            ...
            <div>
              ...
              <div className="px-2 flex justify-center items-center gap-2 pb-4 font-medium text-green-700 text-center">
