                                                                                                                                                ...
                                                                                                                                                <div className='flex flex-col w-full border p-2' key={index + order._id}>
                                                                                                                                                            <div className='flex justify-between items-center px-2'>
                                                                                                                                                                        <div className='flex flex-col'>
                                                                                                                                                                                    ...
                                                                                                                                                                                    <span className='text-sm flex justify-end'>{formatDate(order?.createdAt)}</span>
                                                                                                                                                                        </div>

                                                                                                                                                                        <p className='text-blue-500 hover:underline text-sm font-semibold cursor-pointer hover:scale-105'
                                                                                                                                                            ...
                                                                                                                                                            <div className='mt-2 py-2 px-4 flex h-fit justify-between'>
                                                                                                                                                                        ...
                                                                                                                                                                        <ul className='flex justify-end flex-col'>
                                                                                                                                                                                    <li className='text-right'>Order Status : <span className='text-green-600 font-semibold capitalize'>{order?.orderStatus}</span></li>
                                                                                                                                                                                    <li className='text-right'>Payment : <span className='text-green-600 font-semibold capitalize'>Prepaid</span></li>
